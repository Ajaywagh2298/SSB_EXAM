...
CREATE TABLE `candidate_t` (
  `cad_regist_id` varchar(255) NOT NULL,
  ...
  `minority_status` varchar(200) NOT NULL,
  `relogion` varchar(200) NOT NULL,
  `creamy_code` varchar(200) NOT NULL,
  `certificate_num` varchar(200) NOT NULL,
  `certificate_issue` varchar(30) NOT NULL,
  `certificate_date` varchar(60) NOT NULL,
  `qualcode` varchar(200) NOT NULL,
  `addres1` varchar(200) NOT NULL,
  `addres2` varchar(200) NOT NULL,
  `addres3` varchar(200) NOT NULL,
...
INSERT INTO `candidate_t` (`cad_regist_id`, `name`, `gender`, `birth_date`, `f_name`, `m_name`, `aadhar_num`, `nationality`, `marital`, `community`, `minority_status`, `relogion`, `creamy_code`, `certificate_num`, `certificate_issue`, `certificate_date`, `qualcode`, `addres1`, `addres2`, `addres3`, `state`, `district`, `pincode`, `phone`, `mobile`, `email`, `a_email`) VALUES
('NDA20210201', 'Test', '', '', '', '', 0, '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, 0, 0, '', ''),
('NDA20210203', 'Ajay Rajendra Wagh', 'male', '1998-02-02', 'rajendra', 'sunita', 2147483647, 'indian', 'unmarried', 'sc', 'no', 'NULL', 'NULL class=', '', '', '', '2', 'uf heaiuhflah', 'ia uhi hiuahs dus dSH', 'ia uhi hiuahs dus dSH', '21', '', 423010, 3984938, 2147483647, 'ajay@gmail.com', 'ajay@gmail.com'),
('NDA20210204', '', '0', '', '', '', 0, 'indian', 'NULL', 'NULL', 'NULL', 'NULL', 'no', '', '', '', 'NULL', '', '', '', '', '', 0, 0, 0, '', '');

-- --------------------------------------------------------

--
-- Table structure for table `candidate_t1`
--

CREATE TABLE `candidate_t1` (
  `ca_id` int(20) NOT NULL,
  `cad_regist_id` varchar(30) NOT NULL,
  `proof` varchar(200) NOT NULL,
  `proof_id` varchar(200) NOT NULL,
  `photo` longblob NOT NULL,
  `sign` longblob NOT NULL,
  `militoary_school_student` varchar(20) NOT NULL,
  `son_military_staff` varchar(200) NOT NULL,
  `ncc_cad` varchar(20) NOT NULL,
  `center_1` varchar(200) NOT NULL,
  `center_2` varchar(200) NOT NULL,
  `center_3` varchar(200) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `candidate_t1`
--

INSERT INTO `candidate_t1` (`ca_id`, `cad_regist_id`, `proof`, `proof_id`, `photo`, `sign`, `militoary_school_student`, `son_military_staff`, `ncc_cad`, `center_1`, `center_2`, `center_3`) VALUES
(1, 'NDA20210203', 'Aadhaar Card', '8778787878', 0x363136333d313631323333343139373335352e6a7067, 0x333739303d38356163396432383439393564613737316264333631353361376338343130372e6a7067, 'yes', 'yes', 'yes', 'ahmedabad', 'chandigarh', 'agartala');

-- --------------------------------------------------------

--
-- Table structure for table `candidate_t2`
--

CREATE TABLE `candidate_t2` (
  `id` int(20) NOT NULL,
  `cad_regist_id` varchar(200) NOT NULL,
  `10_mark_num` varchar(200) NOT NULL,
  `10_mark` longblob NOT NULL,
  `12_mark_num` varchar(200) NOT NULL,
  `12_mark` longblob NOT NULL,
  `domicile_num` varchar(200) NOT NULL,
  `domicile_certificate` longblob NOT NULL,
  `nationality_num` varchar(200) NOT NULL,
  `nationality_certificate` longblob NOT NULL,
  `birth_certificate` longblob NOT NULL,
  `aadhar_card` longblob NOT NULL,
  `pan_num` varchar(200) NOT NULL,
  `pan_card` longblob NOT NULL,
  `clg_letter` longblob NOT NULL,
  `risk_certificate` longblob NOT NULL,
  `app_a` longblob NOT NULL,
  `app_c` longblob NOT NULL,
  `creamy_layer_num` varchar(200) NOT NULL,
  `creamy_layer_certificate` longblob NOT NULL,
  `caste_certificate_num` varchar(200) NOT NULL,
  `caste_certificate` longblob NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `candidate_t2`
--

INSERT INTO `candidate_t2` (`id`, `cad_regist_id`, `10_mark_num`, `10_mark`, `12_mark_num`, `12_mark`, `domicile_num`, `domicile_certificate`, `nationality_num`, `nationality_certificate`, `birth_certificate`, `aadhar_card`, `pan_num`, `pan_card`, `clg_letter`, `risk_certificate`, `app_a`, `app_c`, `creamy_layer_num`, `creamy_layer_certificate`, `caste_certificate_num`, `caste_certificate`) VALUES
(1, 'NDA20210203', '23233333', '', '23242444', '', '786483', '', '234', '', '', '', '3434344334', '', '', '', '', '', '22422232323', '', '2322233', '');
...
ALTER TABLE `candidate_t`
  ADD PRIMARY KEY (`cad_regist_id`);

--
-- Indexes for table `candidate_t1`
--
ALTER TABLE `candidate_t1`
  ADD PRIMARY KEY (`ca_id`);

--
-- Indexes for table `candidate_t2`
--
ALTER TABLE `candidate_t2`
  ADD PRIMARY KEY (`id`),
  ADD KEY `cad_regist_id` (`cad_regist_id`);
...
--
ALTER TABLE `candidate_t1`
  MODIFY `ca_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `candidate_t2`
--
ALTER TABLE `candidate_t2`
...
--
-- Constraints for table `candidate_t2`
--
ALTER TABLE `candidate_t2`
  ADD CONSTRAINT `candidate_t2_ibfk_1` FOREIGN KEY (`cad_regist_id`) REFERENCES `candidate_t` (`cad_regist_id`);
COMMIT;
