        ...
        <div class="col-xl-12 col-lg-12 col-md-12">
            <div class="card shadow-sm my-5">
                <div class="card-body p-0">
                            ...
                            <div class="login-form">
                                ...
                                <div class="text-left" style="width: 300px;">
                                    <select class="form-control">
                                        ...
                                        <option value="picture-prescription-test">Picture Prescription Test</option>
                                        <option value="picture-prescription-discussion-test">Picture Prescription & Discussion Test</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="picture-prescription-test box container-login">
                        <div class="row justify-content-center">
                            <div class="col-xl-12 col-lg-12 col-md-12">
                                <div class="card shadow-sm my-5">
                                    <div class="card-body p-0">
                    ...
                    <div class="picture-prescription-discussion-test box container-login">
                        <div class="row justify-content-center">
                            <div class="col-xl-12 col-lg-12 col-md-12">
                                <div class="card shadow-sm my-5">
                                    <div class="card-body p-0">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="login-form">
                                                    <div class="text-center">
                                                        <h1 class="h4 text-gray-900 mb-4">Picture Prescription & Discussion Test</h1>
                                                    </div>
                                                    <form>
                                                        <table class="table align-items-center table-flush" id="dataTable">
                                                            <thead class="thead-light text-center">
